...
@Profile("!dev-local")
@EnableJms
public class JmsConfigCloud extends AbstractJmsConfig {

	private static final Logger LOG = LoggerFactory.getLogger(JmsConfigCloud.class);

	private AmazonSQS sqsClient;
	
	@Autowired
	public JmsConfigCloud(AmazonSQS sqsClient) {
